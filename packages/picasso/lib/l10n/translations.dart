...
abstract class PicassoTranslations {
  PicassoTranslations(String locale) : localeName = intl.Intl.canonicalizedLocale(locale.toString());
  ...
  static const LocalizationsDelegate<PicassoTranslations> delegate = _PicassoTranslationsDelegate();
  ...
  /// No description provided for @layersName.
  ///
  /// In en, this message translates to:
  /// **'Layers'**
  String get layersName;

  /// No description provided for @gifName.
  ///
  /// In en, this message translates to:
  /// **'Gif'**
  String get gifName;

  /// No description provided for @gifPlay.
  ///
  /// In en, this message translates to:
  /// **'Start playback'**
  String get gifPlay;

  /// No description provided for @gifStop.
  ///
  /// In en, this message translates to:
  /// **'Stop playback'**
  String get gifStop;

  /// No description provided for @layersCenter.
  ///
  /// In en, this message translates to:
  /// **'Center'**
  String get layersCenter;

  /// No description provided for @layersRemove.
  ///
  /// In en, this message translates to:
  /// **'Remove'**
  String get layersRemove;
...
class _PicassoTranslationsDelegate extends LocalizationsDelegate<PicassoTranslations> {
  const _PicassoTranslationsDelegate();

  @override
  Future<PicassoTranslations> load(Locale locale) {
    return SynchronousFuture<PicassoTranslations>(lookupPicassoTranslations(locale));
  }
...
PicassoTranslations lookupPicassoTranslations(Locale locale) {
  ...
  switch (locale.languageCode) {
    case 'de': return PicassoTranslationsDe();
    case 'en': return PicassoTranslationsEn();
  }
